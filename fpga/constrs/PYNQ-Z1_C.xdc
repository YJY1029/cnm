...
#create_generated_clock -source [get_pins clk_wiz/clk_in1] -multiply_by 2 -divide_by 5 [get_pins clk_wiz/clk_50] 
create_generated_clock -name clk_50 -source [get_ports sys_clk] -edges {1 2 3} -edge_shift {0.000 6.000 12.000} [get_pins clk_wiz/clk_50]
...
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports stop]; 
#set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports { led[2] }]; #IO_L6P_T0_34 Sch=led[1]
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports bug]; 
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports rst_o]; 
#IO_L23P_T3_35 Sch=led[3]
...
set_multicycle_path -setup -from [get_clocks clk_50] -to [get_clocks sys_clk_pin] 2
set_multicycle_path -hold -end -from [get_clocks clk_50] -to [get_clocks sys_clk_pin] 1

set_multicycle_path -setup -start -from [get_clocks sys_clk_pin] -to [get_clocks clk_50] 2
set_multicycle_path -hold -from [get_clocks sys_clk_pin] -to [get_clocks clk_50] 1
